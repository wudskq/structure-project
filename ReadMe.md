...
​	    <img src="https://aliyun-images-service.oss-cn-hangzhou.aliyuncs.com/wudskq/data/20220503032452.png" alt="image-20220503032452071" style="zoom:50%;" />

- 遇到特殊数据结构时的问题: 1. 树结构被强行链接为单链表 2.查询速度变慢,每次查询都要对左子树进行判空 
...
- 平衡二叉树的常用实现方法有
  ...
  - 伸展树....
- AVL树核心思想(左旋):
  1. 左旋转 (当二叉排序树的右子树高度大于左子树盖度高度时,进行左旋降低右子树高度)
  2. 步骤:
     1. 创建一个新的节点,该节点的值等于根节点的值
     2. 将新节点的左子树指向根节点的左子树
     3. 将新节点的右子树指向根节点的右子树的左子树
     4. 将根节点的值指向为根节点的右子树
     5. 将根节点的右子树指向右子树的右子树
     6. 将根节点的左子树指向新的节点
